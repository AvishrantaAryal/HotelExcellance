        ...
        <div class="box box-default box1">
          ...
          <div class="row test2">
            ...
            <div class="col-md-4 image-mar-b">
              ...
              <a href="{{route('view-gallery',$f->id)}}"><img src="{{asset('/public/uploads/facility/'.$f->facility_image)}}" style="height: 263px; width: 450px;" class="img-responsive" alt="{{$f->image_alt}}">
