...
@foreach($gallery as $g)
		<div class="col-md-4">
			<div class="gallery-img relative-container">
				<a class="thumbnail fancybox" href="{{url('public/uploads/gallery/'.$g['image_name'])}}" rel="lightbox">
					<img src="{{url('public/uploads/gallery/'.$g['image_name'])}}" class="img-responsive gallery-image">
				</a>
			</div>
		</div>
