...
<!-- 		<div class="container-fluid pad-0 treasure-global-btn" style="position: relative;margin-bottom: -43px;z-index: 1;">
		...
		<div class="carousel-item active">
			<img class="d-block w-100" src="{{url('public/uploads/carousel/'.$carousel['c_image'])}}" alt="{{$carousel['alt_image']}}">
		</div>
		

		@foreach($carousels as $c)
		<div class="carousel-item">
			<img class="d-block w-100" src="{{url('public/uploads/carousel/'.$c['c_image'])}}" alt="{{$c['alt_image']}}">
		</div>
		@endforeach
		@else
		<div class="carousel-item active">
			<img class="d-block w-100" src="{{url('public/cd-admin/images/1.jpg')}}" alt="Image1">
		</div>
		

		<div class="carousel-item">
			<img class="d-block w-100" src="{{url('public/cd-admin/images/2.jpg')}}" alt="Image2">
	...
	<div class="row">
		<div class="col-md-5">
			<div class="home-about-image">
				<img src="{{url('public/uploads/about/'.$a['image_name'])}}" alt="{{$a['image_alt']}}" class="img-fluid">
			</div>
		</div>
		<div class="col-md-7">
...
<div class="container pad-bot home-excellence-card">
	...
	<div class="row pad-bot">
		<div class="col-md-6">
			<div class="home-excellence-image">
				<img src="{{url('public/uploads/room/'.$r['cover_image'])}}" alt="{{$r['alt_cover']}}" class="img-fluid">
			</div>
		</div>
	...
	@endforeach
	<div class="container-fluid pad-0 treasure-global-btn">
		<a href="{{url('/room')}}" style="margin-top: 15px;">
